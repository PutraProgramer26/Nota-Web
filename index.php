...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <button class="btn btn-sm btn-outline-light float-end" id="toggleSidebar">☰</button>
        </div>
        <nav class="nav flex-column mt-2">
            <a class="nav-link active" href="index.php"><span class="nav-text">Dashboard</span></a>
            <a class="nav-link" href="input.php"><span class="nav-text">Input Nota</span></a>
            <a class="nav-link" href="lihat_nota.php"><span class="nav-text">Lihat Nota</span></a>
            <a class="nav-link" href="rekap_nota.php"><span class="nav-text">Rekap Nota</span></a>
            <a class="nav-link" href="pengaturan_project.php"><span class="nav-text">Pengaturan Project</span></a>
            <a class="nav-link" href="manajement_user.php"><span class="nav-text">Manajement User</span></a>
            <a class="nav-link text-danger" href="logout.php"><span class="nav-text">Log Out</span></a>
        </nav>
    </div>
